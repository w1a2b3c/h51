                ...
                <div class="layui-side-scroll">
                    ...
                    <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                        ...
                        <li data-name="new" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_fl/add.php">添加分类商品</a>
                                </dd>
                            </dl>
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_fl/list.php">商品分类列表</a>
                                </dd>
                            </dl>
                        </li>
                        <li data-name="new" class="layui-nav-item">
                        ...
                        ?>
                        <li data-name="donation" class="layui-nav-item">
                            <a href="https://zmy.zibovip.top/juanzeng.html"  target="_blank" lay-tips="捐赠" lay-direction="2">
