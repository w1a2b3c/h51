...
$fls_rs = $DB->query("SELECT * FROM `mao_fl` WHERE `M_id` = " . $mao['id'] . ";");
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="name" autocomplete="off" placeholder="如：夏季男T恤纯棉包邮" class="layui-input" value="<?php echo $cha_1['name']?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select id="type">
                                    ...
                                    <?php while($fl =  $DB->fetch($fls_rs)):?>
                                    <option value="<?php echo $fl['id'];?>" <?php if($cha_1['type'] == $fl['id']){echo 'selected';}?>><?php echo $fl['name'];?></option>
                                    <?php endwhile;?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <textarea id="spsm" placeholder="商品说明支持html代码"><?php echo $cha_1['xq']?></textarea>
                        </div>
                    </form>
