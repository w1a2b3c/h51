...
$cha_1 = $DB->get_row("select * from mao_dindan where M_id='{$mao['id']}' and ddh='{$_GET['id']}' limit 1");
        ...
        <div class="fui-content navbar" style="bottom: 0rem;padding-bottom: 0rem;">
            <div class="fui-cell-group">
                ...
                <div class="fui-cell">
                    ...
                    <div class="fui-cell-info c000">
                        <input type="text" class="fui-input" id="shouji" placeholder="请输入收件人手机号" value="<?php echo $_SESSION['shouji']?>" >
                    </div>
                </div>
                <div class="fui-cell">
    ...
    function submit() {
        ...
        $.ajax({
            ...
            success: function (a) {
                layer.close(loading);
                if (a.code == 0) {
                    window.location.href="/orderpay.php?id=" + a.ddh;
                } else {
                    layer.msg(a.msg);
                }
            },
